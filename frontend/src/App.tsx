...
const simklMark = 'https://us.simkl.in/img_favicon/v2/favicon-192x192.png'
...
export function App() {
  ...
  return <div className="min-h-screen">
    ...
    <footer className="shell"><span>Global Media Discovery · read-only public catalog</span><a className="simkl-credit" href="https://simkl.com" target="_blank" rel="noreferrer"><img src={simklMark} alt=""/>Simkl schedule evidence</a><span>React 19.2 · TanStack · Go 1.27</span></footer>
