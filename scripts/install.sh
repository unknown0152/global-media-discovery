...
SIMKL_RULES_ACCEPTED="$(existing_env_value GMD_SIMKL_RULES_ACCEPTED)"
if [ -z "$SIMKL_RULES_ACCEPTED" ]; then
  SIMKL_RULES_ACCEPTED="$(existing_env_value GMD_SIMKL_PERMISSION_CONFIRMED)"
fi
SIMKL_ENABLED="${SIMKL_ENABLED:-false}"
SIMKL_RULES_ACCEPTED="${SIMKL_RULES_ACCEPTED:-false}"
...
GMD_SIMKL_RULES_ACCEPTED='$SIMKL_RULES_ACCEPTED'
